...
w1_og_blastn <- read.table("working_files/wuhan1_blastn_hits.txt", header = FALSE)
w2_og_blastn <- read.table("working_files/wuhan2_blastn_hits.txt", header = FALSE)
...
w1_blastn_tax <- read.table("working_files/wuhan1_blast_with_lineage.txt", sep = "\t", header = TRUE)
w2_blastn_tax <- read.table("working_files/wuhan2_blast_with_lineage.txt", sep = "\t", header = TRUE)
